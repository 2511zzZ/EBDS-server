    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(blank=True, choices=[(0, '离职'), (1, '工人'), (2, '大组长'), (3, '经理'), (4, '总经理')], null=True, verbose_name='员工类别')),
            ],
            options={
                'verbose_name': '公司成员',
        ...
        migrations.AddField(
            model_name='group',
            name='employee',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employee_group', to='sms.Member', verbose_name='大组管理员工号'),
        ),
        migrations.AddField(
            model_name='dpt',
            name='employee',
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, to='sms.Member', verbose_name='生产部管理员工号'),
        ),
        migrations.AddField(
