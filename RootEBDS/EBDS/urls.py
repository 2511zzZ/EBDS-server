...
from form_export.router import report_export_router
from ams.router import ams_router
from cfg.router import user_conf_router
...
route.registry.extend(report_export_router.registry)
route.registry.extend(ams_router.registry)
...
user_route.registry.extend(user_conf_router.registry)

from django.shortcuts import render


def ws_test(request):
    return render(request, 'dms/wb.html')
